...
#include "Renderer.h"
#include <GUI3D/glModel.hpp>
#include <memory>
#include <string>
#include <opencv2/imgproc.hpp>
#include <unordered_map>
#include "Scan3R_json_loader.h"
//#include <codeLib/Eigen.h>
...
namespace PSLAM {
    ...
    public:
        ...
        void Render(const Eigen::Matrix4f &projection, const Eigen::Matrix4f &view, float near, float far) override{
            ...
            RenderInstance(m_label,m_instance, m_bbox);
...
//            cv::waitKey(0);
        ...
        cv::Mat GetLabel() const {return m_label;}
        cv::Mat GetInstance() const {return m_instance;}
        const std::unordered_map<int,Eigen::Vector4i> &GetBoundingBox() const {return m_bbox;}
        std::unordered_map<unsigned long, int> GetColor2Instance() {return m_color2instances;}
        std::unordered_map<int,unsigned long> GetInstance2Color() {return m_instances2color;}
        std::unordered_map<int, std::string> GetInstance2Label(){return m_instances2label;}
    private:
